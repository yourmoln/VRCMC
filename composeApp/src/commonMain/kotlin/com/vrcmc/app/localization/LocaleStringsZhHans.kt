...
object LocaleStringsZhHans : LocaleStrings {
    ...
    override val readAloudFemaleVoice = "女声"
    override val readAloudMaleVoice = "男声"
    override val readAloudRefreshDevices = "刷新设备"
    override val readAloud = "朗读"
    override val enableReadAloud = "启用朗读"
    override val readAloudHint = "启用后使用 Edge TTS 朗读已发送的消息，文本会发送至微软进行语音合成。"
    override val readAloudContent = "朗读内容"
    override val readAloudOriginal = "原文"
    override val readAloudTranslation = "仅译文"
    override val readAloudOutgoing = "最终发送文本"
    override val readAloudVoice = "朗读音色"
    override val searchReadAloudVoice = "搜索音色或语言"
    override val readAloudOutputDevice = "播放设备"
    override val readAloudSystemDefault = "系统默认"
    override val readAloudDeviceUnavailable = "所选设备不可用，请重新连接或选择其他设备。"
    override val readAloudRefresh = "刷新"
    override val readAloudPreview = "试听"
    override val readAloudStop = "停止"
    override val readAloudSample = "你好，这是朗读试听。"
    override val readAloudVoicesFailed = "音色加载失败，请刷新重试，仍可使用已保存的音色。"
    override val readAloudFailed = "朗读失败，请检查网络、音色和播放设备。"
    override val hotwordDictionary = "热词字典"
    override val keywordReplacement = "关键词替换"
    override val sentenceBlocking = "句子屏蔽"
    override val keyword = "关键词"
    override val replacementTarget = "目标词"
    override val blockedSentence = "屏蔽句子"
    override val addDictionaryEntry = "添加条目"
    override val editDictionaryEntry = "编辑条目"
    override val importJson = "导入 JSON"
    override val exportJson = "导出 JSON"
    override val importJsonFile = "导入 JSON 文件"
    override val exportJsonFile = "导出 JSON 文件"
    override val invalidDictionaryJson = "字典 JSON 格式无效"
    override val dictionarySaved = "已保存"
    override val dictionaryImported = "已导入"
    override val dictionaryExported = "已导出"
    override val dictionarySaveFailed = "字典保存失败"
    override val emptyDictionary = "暂无条目"
    override val duplicateDictionaryEntry = "该条目已存在"
    override val sentenceBlocked = "已屏蔽"
    override val replaceDictionaryTitle = "替换字典？"
    override val replaceDictionaryMessage = "导入将替换当前的两个字典列表。"
    override val quickStart = "快速上手"
    override val quickStartQwen = "配置 Qwen"
    override val quickStartTranslation = "配置翻译"
    override val useFreeBingTranslation = "使用免费的必应翻译"
    override val quickStartBingHint = "无需 API Key 或充值，即可免费翻译聊天文字。"
    override val bingConfigureSuccess = "免费必应翻译已配置并开启。"
    ...
    override val showOriginalText = "显示原文"
    override val showOriginalTextHint = "关闭后，译文生成完成时隐藏原文。"
    ...
    override val showJapaneseRomaji = "在日语译文上方显示罗马音"
    override val japaneseDictionaryDownloading = "正在下载日语词典…"
    override val japaneseDictionaryDownloadFailed = "日语词典下载失败"
    override val retryJapaneseDictionaryDownload = "重新下载日语词典"
