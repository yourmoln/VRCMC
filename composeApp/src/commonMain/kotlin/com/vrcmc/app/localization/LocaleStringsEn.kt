...
object LocaleStringsEn : LocaleStrings {
    ...
    override val originalTextOutput = "Original text"
    override val showOriginalText = "Show original text"
    override val showOriginalTextHint = "When disabled, the original text is hidden after the translation is ready."
    ...
    override val disableAutomaticUpdateCheck = "Disable automatic update checks"
    override val showTypingStatus = "Show typing status in VRChat"
    override val liveInputPreview = "Show input text live in VRChat"
    override val liveInputPreviewDelay = "Refresh after the last send"
    ...
    override val showJapaneseRomaji = "Show romaji above Japanese translations"
    override val japaneseDictionaryDownloading = "Downloading Japanese dictionary…"
    override val japaneseDictionaryDownloadFailed = "Japanese dictionary download failed"
    override val retryJapaneseDictionaryDownload = "Retry Japanese dictionary download"
    ...
    override val simultaneousInterpretationInputHint =
        "This feature can be used together with your keyboard's voice input function."
    override val interpretationVoiceInput = "Enable voice input with interpretation"
    override val interpretationVoiceInputHint =
    ...
    override val repository = "GitHub repository"
    override val checkForUpdates = "Check for updates"
    override val checkingForUpdates = "Checking for updates..."
    override val alreadyLatestVersion = "You are using the latest version"
    ...
    override val updateDownload = "Update"
    ...
    override val qwenSampleRate = "Sample rate"
    override val qwenMaxSegment = "Maximum recording length"
    override val qwenTailSilence = "Trailing silence"
    override val qwenVadMinRms = "Minimum speech volume (RMS)"
    override val qwenVadSpeechRatio = "Speech frame ratio"
    override val qwenPartialInterval = "Live recognition interval"
    override val qwenTimeout = "Request timeout"
    override val startVoiceInput = "Start voice input"
    override val stopVoiceInput = "Stop voice input"
    override val transcribingVoiceInput = "Transcribing voice..."
