                        ...
                        Box {
                            ...
                            DropdownMenu(ipMenuExpanded, { ipMenuExpanded = false }) {
                                addresses.forEach { address ->
                                    DropdownMenuItem(
                                        text = { Text(address) },
                                        leadingIcon = { if (address == localIp) Icon(Icons.Default.Check, null) },
                                        onClick = {
                                            localIp = address
                                            copied = false
        ...
        item {
            Surface(
                ...
                Row(Modifier.padding(16.dp), verticalAlignment = Alignment.Top) {
                    Icon(Icons.Default.Info, null, Modifier.size(20.dp), tint = MaterialTheme.colorScheme.onSecondaryContainer)
                    Spacer(Modifier.width(10.dp))
